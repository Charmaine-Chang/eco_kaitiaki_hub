...
def get_traps_export_data(group_id, date_from=None, date_to=None):
    ...
    query = '''
        SELECT tc.trap_code AS code, TO_CHAR(tc.date, 'YYYY-MM-DD HH24:MI') AS date, 
...
def get_bait_stations_export_data(group_id, date_from=None, date_to=None):
    ...
    query = '''
        SELECT bsr.bait_station_code AS code, TO_CHAR(bsr.date, 'YYYY-MM-DD HH24:MI') AS date, 
