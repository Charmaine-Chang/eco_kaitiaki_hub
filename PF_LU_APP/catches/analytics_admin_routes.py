...
from PF_LU_APP.db import get_cursor, get_cursor_context
...
from PF_LU_APP.catches.analytics_repository import fetch_data_graphs, fetch_trend_analytics


@admin_bp.route('/graphs', methods=['GET', 'POST'])
...
def data_graphs():
    ...
    try:
        ...
        return render_template('dashboards/graphs.html',
                               ...
                               kpis={
                                   'total_catches': 0, 'active_lines': 0, 'active_stations': 0,
                               ...
                               station_hotspots=[], role='admin')


@admin_bp.route('/graphs/download-report', methods=['GET'])
...
def download_graphs_report():
    ...
    try:
        ...
        return redirect(url_for('admin.data_graphs', line_id=line_id, start_date=start_date, end_date=end_date))


@admin_bp.route('/trend-analytics', methods=['GET'])
@roles_required(ROLE_SUPER_ADMIN, ROLE_COORDINATOR, ROLE_OPERATOR, ROLE_OBSERVER)
def trend_analytics():
