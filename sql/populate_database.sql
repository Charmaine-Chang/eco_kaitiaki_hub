-- =========================================================================
-- PostgreSQL Database Population (Mock Data for Multi-Conservation Groups)
-- =========================================================================
-- Ensure you run `create_database.sql` before running this script.

-- 1. Insert Roles (Updated for Multi-Conservation Group schema)
...
-- 8. Insert Users 
-- Using default password hashes setup in create_database.sql (Password123!)
...
-- 9. Insert Groups (Multiple Conservation Groups as requested)
...
(1, 1, 1, 'active'), -- superadmin in System Management
(1, 1, 2, 'active'), -- superadmin in Darfield
(1, 1, 3, 'active'), -- superadmin in West Melton
(1, 1, 4, 'active'), -- superadmin in Springston

-- Group Coordinators
(2, 2, 2, 'active'), -- alice in Darfield
(3, 2, 3, 'active'), -- bob in West Melton
(4, 2, 4, 'active'), -- charlie in Springston

-- Operators
(5, 3, 2, 'active'), -- dave in Darfield
(6, 3, 2, 'active'), -- eve in Darfield
(7, 3, 3, 'active'), -- frank in West Melton
(8, 3, 3, 'active'), -- grace in West Melton
(9, 3, 4, 'active'), -- heidi in Springston
(10, 3, 4, 'active'), -- ivan in Springston

-- Observers
(11, 4, 2, 'active'), -- judy in Darfield
(12, 4, 3, 'active'), -- ken in West Melton
(13, 4, 4, 'active'); -- leo in Springston

-- Showcase Multi-conservation group membership (Users belong to multiple groups)
INSERT INTO "group_membership" (user_id, role_id, group_id, membership_status) VALUES
(5, 4, 3, 'active'), -- dave (operator in Darfield) is also observer in West Melton
(3, 4, 4, 'active'); -- bob (coordinator in West Melton) is also observer in Springston

-- 11. Insert Lines (Includes new Bait Station lines)
...
(5, 1), (6, 1), -- dave and eve on Darfield Main Track
(5, 2),         -- dave on Darfield Bait Line
(7, 3), (8, 3), -- frank and grace on West Melton River Line
(9, 4), (10, 4),-- heidi and ivan on Springston Reserve
(9, 5),         -- heidi on Springston Perimeter
(6, 6),         -- eve on Darfield North Ridge
(8, 7),         -- grace on West Melton Forest
(10, 8);        -- ivan on Springston Riverbank
...
-- 14. Inventory Items (storage_area_id: 1=Darfield, 2=West Melton, 3=Springston)
...
-- 17. Insert Trap Catches (Expanded)
...
('D-T1', '2026-03-01 08:30:00', 5, 4, 'Male', 'Adult', 3, TRUE, 29, 1, 1, 'Caught a large Possum in Darfield'),
('D-T2', '2026-03-01 08:45:00', 6, 11, NULL, NULL, 4, FALSE, 25, 1, 0, 'Checked, all clear'),
('D-T3', '2026-03-02 09:00:00', 5, 2, 'Unknown', 'Adult', 3, TRUE, 29, 1, 1, 'Hedgehog found'),
('D-T1', '2026-03-05 08:30:00', 5, 3, 'Female', 'Juvenile', 3, TRUE, 29, 1, 1, 'Mouse in DOC 150'),
('D-T4', '2026-03-06 09:15:00', 6, 11, NULL, NULL, 4, FALSE, 25, 1, 0, 'All clear'),
('D-T2', '2026-03-08 08:20:00', 5, 4, 'Male', 'Adult', 3, TRUE, 29, 1, 1, 'Another possum.'),
('D-T3', '2026-03-10 09:10:00', 6, 11, NULL, NULL, 6, TRUE, 29, 1, 0, 'Bait missing, set again.'),
('W-T1', '2026-03-02 08:30:00', 7, 8, 'Male', 'Juvenile', 3, TRUE, 29, 1, 1, 'Stoat caught near river'),
('W-T2', '2026-03-03 10:00:00', 8, 4, 'Female', 'Adult', 3, TRUE, 29, 1, 1, 'Possum caught'),
('W-T3', '2026-03-04 11:30:00', 7, 11, NULL, NULL, 4, FALSE, 25, 1, 0, 'Checked, all clear'),
('W-T1', '2026-03-08 09:00:00', 8, 3, 'Male', 'Adult', 3, TRUE, 29, 1, 1, 'Small mouse'),
('W-T2', '2026-03-10 10:15:00', 7, 11, NULL, NULL, 5, TRUE, 29, 2, 0, 'Bait rotten, trap needs maintenance'),
('S-T1', '2026-03-03 08:45:00', 9, 11, NULL, NULL, 4, FALSE, 25, 1, 0, 'Checked, all clear'),
('S-T2', '2026-03-05 09:45:00', 10, 6, 'Male', 'Adult', 3, TRUE, 29, 1, 1, 'Norway rat caught'),
('S-T3', '2026-03-07 08:00:00', 9, 11, NULL, NULL, 5, TRUE, 29, 2, 0, 'Bait was bad, replaced it. Trap needs slight oiling.'),
('S-T1', '2026-03-09 08:30:00', 10, 4, 'Female', 'Juvenile', 3, TRUE, 29, 1, 1, 'Small possum'),
('S-T2', '2026-03-12 09:00:00', 9, 6, 'Female', 'Adult', 3, TRUE, 29, 1, 1, 'Another rat'),
('S-T3', '2026-03-14 08:15:00', 10, 11, NULL, NULL, 4, FALSE, 25, 1, 0, 'All clear after oiling'),
('D-T5', '2026-03-05 08:30:00', 6, 4, 'Female', 'Adult', 3, TRUE, 29, 1, 1, 'Possum caught on new ridge line'),
('D-T6', '2026-03-05 08:45:00', 6, 11, NULL, NULL, 4, FALSE, 25, 1, 0, 'No catch'),
('W-T4', '2026-03-07 10:00:00', 8, 8, 'Male', 'Juvenile', 3, TRUE, 29, 1, 1, 'Stoat caught'),
('W-T5', '2026-03-07 10:15:00', 8, 11, NULL, NULL, 5, TRUE, 29, 2, 0, 'Bait taken, no catch'),
('S-T4', '2026-03-10 09:30:00', 10, 6, 'Male', 'Adult', 3, TRUE, 29, 1, 1, 'Rat'),
('S-T5', '2026-03-10 09:45:00', 10, 3, 'Female', 'Adult', 3, TRUE, 29, 1, 1, 'Mouse'),
('D-T5', '2026-03-12 08:30:00', 6, 11, NULL, NULL, 4, FALSE, 25, 1, 0, 'Checked, all clear'),
('W-T4', '2026-03-14 10:00:00', 8, 2, 'Unknown', 'Adult', 3, TRUE, 29, 1, 1, 'Hedgehog');
...
-- 20. Bait Station Records (Expanded)
...
((SELECT group_id FROM groups WHERE group_name = 'Darfield Possum Catch Group'), 1, 'Guide', 'How to set a DOC 200', 'Always use the safety clip when setting the trap to avoid injury.', TRUE, TRUE, 'approved'),
((SELECT group_id FROM groups WHERE group_name = 'West Melton Predator-Free'), 3, 'Resource', 'Common pests in West Melton', 'Rats and stoats are very common. Watch out for nesting areas.', FALSE, TRUE, 'approved'),
((SELECT group_id FROM groups WHERE group_name = 'Darfield Possum Catch Group'), 2, 'Guide', 'Bait Station Best Practices', 'Ensure bait is secured properly to avoid non-target species taking it.', TRUE, TRUE, 'approved'),
((SELECT group_id FROM groups WHERE group_name = 'Springston Conservation Group'), 4, 'Species Info', 'Identifying Ship Rats vs Norway Rats', 'Ship rats have larger ears and a tail longer than their body.', FALSE, TRUE, 'approved'),
((SELECT group_id FROM groups WHERE group_name = 'Darfield Possum Catch Group'), 1, 'Safety', 'Handling toxins', 'Always wear gloves and wash hands thoroughly after handling bait.', TRUE, TRUE, 'approved'),
((SELECT group_id FROM groups WHERE group_name = 'Darfield Possum Catch Group'), 2, 'Guide', 'Seasonal Trapping Strategies', 'Winter brings more rodents looking for shelter. Increase bait checks.', FALSE, TRUE, 'approved'),
((SELECT group_id FROM groups WHERE group_name = 'Darfield Possum Catch Group'), 1, 'Species Info', 'Hedgehogs: Friend or Foe?', 'While cute, hedgehogs eat native bird eggs and insects. They are a pest.', TRUE, TRUE, 'approved'),
((SELECT group_id FROM groups WHERE group_name = 'West Melton Predator-Free'), 3, 'Safety', 'Riverbank Safety Protocol', 'The recent floods have eroded some tracks. Stay 2m away from the edge.', TRUE, TRUE, 'approved');

-- 22. Group Updates & Comments
INSERT INTO "group_updates" (group_id, user_id, update_title, update_content, is_published) VALUES
(2, 2, 'Welcome to Darfield Trappers', 'Let''s get out there and catch some pests!', TRUE),
(3, 3, 'West Melton River Cleanup', 'Meet at the main carpark at 9am.', TRUE),
(4, 4, 'Springston Update', 'We had a great catch rate this month, keep up the good work team!', TRUE),
(2, 2, 'Monthly meeting next week', 'We will be discussing trap placements for the new ridge line.', TRUE),
(4, 4, 'New bait stations deployed', 'Check out the new stations on the riverbank line.', TRUE),
(2, 2, 'Trap Box Maintenance Day', 'We need volunteers this weekend to help repair some of the older wooden trap boxes. Pizza provided!', TRUE),
(3, 3, 'Stoat Sighting Alert', 'A large stoat was spotted near the north bridge. Please ensure all DOC200s in that sector are freshly baited.', TRUE),
(4, 4, 'Welcome New Members!', 'Great to see so many new faces joining the Springston effort this week.', TRUE),
(2, 2, 'Draft: End of Year Stats', 'Draft post, please ignore for now.', FALSE);
...
-- (User IDs: Dan=14, Erin=15, Liam=16, Mia=17, Noah=18, Olivia=19, Paul=20, Quinn=21, Ryan=22, Sara=23)
-- (Group IDs: Kaikoura=5, Port Hills=6, Selwyn=7)
INSERT INTO "group_membership" (user_id, role_id, group_id, membership_status) VALUES
(1, 1, 5, 'active'), (1, 1, 6, 'active'), (1, 1, 7, 'active'), -- superadmin in all
(14, 2, 5, 'active'), -- Dan coord Kaikoura
(15, 2, 6, 'active'), -- Erin coord Port Hills
(2, 2, 7, 'active'),  -- Alice (already exists) coord Selwyn
(16, 3, 5, 'active'), (17, 3, 5, 'active'), -- Liam, Mia ops Kaikoura
(18, 3, 6, 'active'), (19, 3, 6, 'active'), -- Noah, Olivia ops Port Hills
(20, 3, 7, 'active'), (21, 3, 7, 'active'), -- Paul, Quinn ops Selwyn
(22, 4, 5, 'active'), (23, 4, 6, 'active'); -- Ryan obs Kaikoura, Sara obs Port Hills
...
-- (Line IDs: Coastal=9, Lookout=10, Summit=11, Valley=12, Farm=13, Shelter=14)
INSERT INTO "operator_lines" (user_id, line_id) VALUES 
(16, 9), (17, 9), -- Liam and Mia on Coastal
(16, 10),         -- Liam on Lookout
(18, 11), (19, 11), -- Noah and Olivia on Summit
(19, 12),         -- Olivia on Valley
(20, 13), (21, 13), -- Paul and Quinn on Farm
(20, 14);         -- Paul on Shelter
...
-- 31. Additional Trap Catches (Large batch for variety)
INSERT INTO "trap_catches" (trap_code, date, recorded_by, species_id, sex, maturity, trap_status_id, rebaited, bait_type_id, trap_condition_id, strikes, note) VALUES 
('K-T1', '2026-04-01 10:00:00', 16, 7, 'Male', 'Adult', 3, TRUE, 29, 1, 1, 'Ship rat caught on dunes'),
('K-T2', '2026-04-01 10:15:00', 17, 11, NULL, NULL, 4, FALSE, 25, 1, 0, 'Checked, all clear'),
('K-T3', '2026-04-05 11:00:00', 16, 8, 'Female', 'Adult', 3, TRUE, 43, 1, 1, 'Stoat caught with egg bait'),
('P-T1', '2026-04-02 09:00:00', 18, 4, 'Male', 'Adult', 3, TRUE, 29, 1, 1, 'Possum in Port Hills'),
('P-T2', '2026-04-02 09:15:00', 19, 11, NULL, NULL, 4, FALSE, 25, 1, 0, 'No activity'),
('P-T3', '2026-04-06 10:30:00', 18, 5, 'Male', 'Juvenile', 3, TRUE, 29, 1, 1, 'Kiore rat found'),
('S-T6', '2026-04-03 08:00:00', 20, 1, 'Male', 'Adult', 3, TRUE, 42, 1, 1, 'Ferret caught near farm perimeter'),
('S-T7', '2026-04-03 08:15:00', 21, 6, 'Female', 'Adult', 3, TRUE, 29, 1, 1, 'Norway rat'),
('S-T8', '2026-04-07 09:00:00', 20, 11, NULL, NULL, 4, FALSE, 25, 1, 0, 'Clean check'),
('K-T1', '2026-04-10 10:00:00', 16, 7, 'Female', 'Adult', 3, TRUE, 29, 1, 1, 'Another ship rat'),
('P-T1', '2026-04-12 09:00:00', 18, 4, 'Female', 'Adult', 3, TRUE, 29, 1, 1, 'Large female possum'),
('S-T6', '2026-04-15 08:00:00', 20, 1, 'Female', 'Juvenile', 3, TRUE, 42, 1, 1, 'Young ferret caught');
...
-- 36. Additional Inventory Items for new groups
...
-- 34. Additional Knowledge Hub Entries
INSERT INTO "knowledge_hub" (group_id, user_id, category, title, content, is_featured, is_published, status) VALUES
((SELECT group_id FROM groups WHERE group_name = 'Kaikoura Coastal Protection'), 14, 'Species Info', 'Kaikoura Peninsula Seabirds', 'We are protecting the Hutton''s shearwater nesting sites.', TRUE, TRUE, 'approved'),
((SELECT group_id FROM groups WHERE group_name = 'Port Hills Restoration Trust'), 15, 'Guide', 'Port Hills Native Planting', 'How to plant natives that provide habitat for birds but not cover for pests.', FALSE, TRUE, 'approved');

-- 35. Additional Group Updates
INSERT INTO "group_updates" (group_id, user_id, update_title, update_content, is_published) VALUES
(5, 14, 'Coastal Project Launch', 'Welcome everyone to the Kaikoura coastal protection project!', TRUE),
(6, 15, 'Summit Line Survey', 'We completed the survey for the new Summit Walk line.', TRUE),
(7, 2, 'Farm Safety Notice', 'Please watch out for electric fences on the south boundary.', TRUE);
